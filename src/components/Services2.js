...
export default function Services(){
    ...
    return(
        <div id="services" className="font-plus overflow-hidden mt-36 bg-black text-center grid justify-items-center">
            ...
            <div className="flex flex-col md:flex-row items-center mt-8 gap-16 mb-24 px-2">
                <div className="relative bg-gradient-to-b from-roxo to-black bg-opacity-40 md:w-[23rem] md:h-[28rem] w-[17rem] h-[23rem] rounded-xl place-content-center grid justify-items-center">
                     <img className="md:size-28 size-24" src={laptop}></img>
                ...
                <div className="relative bg-gradient-to-b from-roxo to-black bg-opacity-40 md:w-[23rem] md:h-[28rem] w-[17rem] h-[23rem] rounded-xl place-content-center grid justify-items-center">
                    <img className="md:size-20 size-20" src={web}></img> 
