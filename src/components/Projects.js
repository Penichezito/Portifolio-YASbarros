...
export default function Projects(){
    ...
    return(
        ...
        <div id="projects" className="relative dark:bg-gray-950  dark:text-slate-300 container mx-auto px-5 grid justify-items-center text-center mt-10 mb-14 font-plus md:gap-40 gap-20">
            ...
            <div className="z-0 absolute blur-3xl md:top-[5rem] top-[8rem] md:left-[0rem] bg-gradient-to-r from-azul to-purpleLigth opacity-20 rounded-full w-96 h-56 md:w-[25rem] md:h-[25rem]"></div>
            <div className="z-0 absolute blur-3xl top-[57rem] md:top-[37rem] md:left-[70rem] bg-gradient-to-r from-azul to-purpleLigth opacity-20 rounded-full w-96 h-56 md:w-[25rem] md:h-[25rem] "></div>
            <div className="z-0 absolute blur-3xl top-[110rem] md:left-[0rem] bg-gradient-to-r from-azul to-purpleLigth opacity-20 rounded-full w-96 h-56 md:w-[25rem] md:h-[25rem] "></div>
            <div className="z-0 absolute blur-3xl top-[158rem] md:top-[105rem] md:left-[70rem] bg-gradient-to-r from-azul to-purpleLigth md:opacity-20 opacity-35 rounded-full md:w-[25rem] md:h-[25rem] w-96 h-56"></div>
