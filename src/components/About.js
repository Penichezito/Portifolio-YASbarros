            ...
            <div className="z-10 md:flex-row flex flex-col items-center">
                <div className="relative flex justify-center md:mx-10 ">
                    {/* <div className=" absolute z-0 left-20 top-7 bg-red-300 shadow-lg w-[20rem] h-[27rem] rounded-[10px]"></div> */}
                        <img className="shadow-lg shadow-slate-500 dark:shadow-black rounded-[40px] z-10 md:w-[67rem] md:h-[32rem] w-[21rem] h-[26rem]" src={eu} alt={t('My Image')} />
                    
                </div>

                <div className="leading-6 text-justify font-medium p-8 mt-8">
                    <p className="font-medium ">
                        <span className="text-xl font-semibold text-slate-700 dark:text-slate-300">{t('Hello, my name is Yasmim Barros!')}</span>
                        <br/>
                        <br/>
                        {t('I am 22 years old, born in Bahia, born in the city of Salvador, but residing in Feira de Santana.')} <br /> <br /> 
                    ...
                    <div className="w-40 h-32 bg-gradient-to-b from-slate-300  to-white  dark:from-slate-800 dark:to-slate-950  rounded-2xl flex justify-center items-center">
                        <div className="flex flex-col items-center gap-2">
                            ...
                            <h1 className="text-center text-sm font-bold px-6">{t('Sistemas de Informação')}</h1>
