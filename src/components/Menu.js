...
export default function Contact(){
    ...
    return(
        <div id="contact" className=" dark:bg-black dark:text-slate-300 container mx-auto my-20 font-plus">
            <div id="title" className=" text-center grid justify-items-center md:justify-items-start">
                <h1 className="mt-4 mb-2 text-4xl text-slate-700 dark:text-slate-300 ">{t("Contato")}</h1>
                <div class="h-[3px] w-28 bg-gradient-to-l from-transparent via-roxo to-roxo"></div>
                <p className=" mt-3 mb-20 md:text-lg text-slate-600 dark:text-slate-300 ">{t("E ai, ficou interessado? Entre em contato e vamos conversar!")}</p>
            </div>

            <div className=" flex-col md:flex-row gap-24 grid justify-items-center md:justify-items-start">
                <div id="form" >
                    <form className="flex flex-col gap-5 md:w-[25rem] w-[20rem] text-slate-700 dark:text-slate-300 " onSubmit={sendEmail}>
                ...
                <div id="buttons" className="flex flex-col place-content-center gap-8">
                    <a href="mailto:barrosyasmim13@gmail.com" className=" flex items-center justify-center relative transition duration-500 bg-sky-600  hover:bg-blue-800 rounded-2xl w-72 h-16 shadow-xl text-white">
                        <span className="flex flex-row gap-2 w-40 items-center justify-center">
                            <svg className="" width="25" height="25" viewBox="0 0 53 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a target='_blank' href="https://api.whatsapp.com/send?phone=5575983588457" className="flex items-center justify-center relative transition duration-500 bg-sky-600  hover:bg-blue-800 rounded-2xl w-72 h-16 shadow-xl text-white">
                        <span className="flex flex-row gap-2 items-center justify-center w-40">
                            <svg className="" width="25" height="25" viewBox="0 0 61 59" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a target='_blank' href="https://www.instagram.com/yascoder" className="flex items-center justify-center relative transition duration-500 bg-sky-600 hover:bg-blue-800 rounded-2xl w-72 h-16 shadow-xl text-white">
                        <span className="flex flex-row gap-2 w-40 items-center justify-center ">
                            <svg className="" width="25" height="25" viewBox="0 0 61 61" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a target='_blank' href="https://www.instagram.com/yascoder" className="flex items-center justify-center relative transition duration-500 bg-sky-600  hover:bg-blue-800 rounded-2xl w-72 h-16 shadow-xl text-white">
                        <span className="flex flex-row gap-2  w-40 items-center justify-center ">
                            <svg className="" width="25" height="25" viewBox="0 0 70 69" fill="none" xmlns="http://www.w3.org/2000/svg">
