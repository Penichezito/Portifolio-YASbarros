    ...
    return(
        <div id="contact" className=" dark:bg-black dark:text-slate-300 container mx-auto my-20 font-plus">
            <div id="title" className="">
                ...
                <p className=" mt-3 mb-20 text-lg text-slate-600 dark:text-slate-300 ">{t("E ai, ficou interessado? Entre em contato e vamos conversar!")}</p>
            </div>

            <div className="flex flex-row gap-24">
                <div id="form" >
                    <form className="flex flex-col gap-5 w-[25rem] text-slate-700 dark:text-slate-300 " onSubmit={sendEmail}>
