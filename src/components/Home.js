...
import audio1 from '../audio/feelings.mp3'
        ...
        <div id="home" className=" dark:bg-gray-950 dark:text-slate-300 font-plus text-slate-800 relative grid justify-items-stretch mt-16">
            ...
            <div className=" md:mt-20 mt-8 mx-8 md:flex-row flex-col flex justify-between">
                ...
                <div className=" flex md:flex-col flex-row md:gap-10  gap-5 items-center md:justify-start justify-center">
                    ...
                    <button className="shadow-lg   dark:shadow-slate-700 shadow-gray-400 active:shadow-inner rounded-full w-16 h-7 md:w-12 md:h-28 dark:active:shadow-slate-700 text-sm md:text-lg" onClick={() => changeLanguage(i18n.language === 'en' ? 'pt' : 'en')}>
                        {i18n.language === 'en' ? 'PT' : 'EN'}
                    </button>



                    <button className={`shadow-lg ${theme === "dark" ? ' dark:shadow-slate-700' : ' shadow-gray-400'} active:shadow-inner dark:active:shadow-gray-700 rounded-full w-16 h-7 md:w-12 md:h-28 flex justify-center items-center`}onClick={handleThemeSwitch}>
                    {theme === "ligth" ? (
                        <svg
                ...
                <div className="absolute flex justify-center items-center top-40 left-28 md:top-48 md:left-[12rem] z-0 md:w-[67rem] md:h-[27rem] w-48 h-60">
                ...
                <div className="z-10 flex flex-col-reverse md:flex-row gap-16 px-5 md:px-14">
                    <div className="md:my-36 mt-[-50px] md:mt-44 mb-0 text-center md:text-left md:ml-24">
                        ...
                        <p className="font-semibold dark:text-gray-400 text-gray-600 text-base md:text-xl">{t("Oi! Eu sou a Yasmim, uma desenvolvedora de software")}</p>
                        <p className="font-semibold dark:text-gray-400 text-gray-600 text-base md:text-xl">{t("e estudante de Sistemas de Informação.")}</p>
