    ...
    return(
        <div id="home" className=" dark:bg-gray-950 dark:text-slate-300 font-plus text-slate-800 relative grid justify-items-stretch mt-16">
            ...
            <div className=" md:mt-20 mt-8 mx-8 md:flex-row flex-col flex justify-between">
                ...
                <div class="absolute flex justify-center items-center top-40 left-28 md:top-44 md:left-[12rem] z-0 md:w-[67rem] md:h-[20rem] w-48 h-52">
                    <div class="bg-gradient-to-r from-azul to-purpleLigth absolute inset-0 blur-3xl rounded-full opacity-30 transform rotate-12 origin-center"></div>
                </div> 
